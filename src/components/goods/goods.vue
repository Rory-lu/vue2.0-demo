            ...
            <li v-for="food in item.foods" class="food-item border-1px" @click="selectedFood(food, $event)">
              ...
              <div class="content">
                ...
                <div class="cartcontrol-wrapper">
                  <cartcontrol v-on:cartAdd="_drop($event)" :food="food"></cartcontrol>
                </div>
              </div>
            </li>
          </ul>
  ...
  export default {
    ...
    created() {
      this.$http.get('/api/goods').then((response) => {
        ...
        if (responseDatas.errno === ERR_OK) {
          this.goods = responseDatas.data;
    ...
    methods: {
      ...
      _drop (target) {
        // 优化动画
        this.$nextTick(() => {
          // 调用shopcart子组件里面的drop方法,,在vue的父组件如何去访问到子组件的方法
